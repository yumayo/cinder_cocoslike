...
void app_delegate::update( )
{
    ...
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_update( delta );
...
void app_delegate::draw( )
{
    ...
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_render( cinder::mat3( ) );
}
...
void app_delegate::touchesBegan( cinder::app::TouchEvent event )
{
    if ( _touch_id == _INVALID_ID )
    {
        ...
        if ( itr != event.getTouches( ).end( ) )
        {
            ...
            treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touch_began( *itr );
        }
    }

    treelike::scene_manager::get_instans( )->top( )->_touches_began( event );
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touches_began( event );
}
void app_delegate::touchesMoved( cinder::app::TouchEvent event )
{
    ...
    if ( itr != event.getTouches( ).end( ) )
    {
        ...
        treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touch_moved( *itr );
    }

    treelike::scene_manager::get_instans( )->top( )->_touches_moved( event );
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touches_moved( event );
}
void app_delegate::touchesEnded( cinder::app::TouchEvent event )
{
    ...
    if ( itr != event.getTouches( ).end( ) )
    {
        ...
        treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touch_ended( *itr );
        _touch_id = _INVALID_ID;
    }

    treelike::scene_manager::get_instans( )->top( )->_touches_ended( event );
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_touches_ended( event );
}
void app_delegate::keyDown( cinder::app::KeyEvent event )
{
    treelike::scene_manager::get_instans( )->top( )->_key_down( event );
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_key_down( event );
}
void app_delegate::keyUp( cinder::app::KeyEvent event )
{
    treelike::scene_manager::get_instans( )->top( )->_key_up( event );
    treelike::scene_manager::get_instans( )->get_dont_destroy_node( ).lock( )->_key_up( event );
}
}